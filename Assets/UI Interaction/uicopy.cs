namespace VRTK.Examples
{
    ...
    public class uicopy : MonoBehaviour
    {
        ...
        StreamWriter sp;
        //public int tp_int;
        public static int random_2d;
        public static int random_3d;
        public static int random_3dmass;
        ...
        private void Start()
        {
            if (cnt_red == 0)
            {
                random_2d = Random.Range(1, 4);
            }
            if (cnt_pinkwhole == 0)
            {
                random_3d = Random.Range(1, 4);
            }
            if (cnt_pinkonly == 0)
            {
                random_3dmass = Random.Range(1, 4);
            }
            if (cnt_multiple == 0)
            {
        ...
        public void Button_Pink()  //ir
        {
            ...
            else
            {
                ...
                {
                    switch (random_3d + cnt_pinkwhole)
                    {
                        case 1: SceneManager.LoadScene("iregularshapeahead"); break;
                        case 2: SceneManager.LoadScene("iregularshapedelay"); break;
                        case 3: SceneManager.LoadScene("iregularshapeinstant"); break;
        ...
        public void Button_Pinkonly()   //mass
        {
            ...
            else
            {
                ...
                {
                    switch (random_3dmass + cnt_pinkonly)
                    {
                        case 1: SceneManager.LoadScene("regularshapeinstant"); break;
                        case 2: SceneManager.LoadScene("regularshapeahead"); break;
                        case 3: SceneManager.LoadScene("regularshapedelay"); break;
