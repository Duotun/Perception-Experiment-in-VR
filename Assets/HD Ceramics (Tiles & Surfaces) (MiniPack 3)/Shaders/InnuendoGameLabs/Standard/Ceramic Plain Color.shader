...
Shader "InnuendoGameLabs/Standard/Ceramic Plain Color" {
    Properties {
        _Color ("Color", Color) = (0.7137255,0.7058824,0.6588235,1)
...
////// Specular:
                ...
                float node_5690 = clamp(_SpecularMultiplierClamped010,0.0,10.0);
                float3 specularColor = float3(node_5690,node_5690,node_5690);
